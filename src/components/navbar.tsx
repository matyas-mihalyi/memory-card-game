...
export const Navbar = ({isVisible, toggleModal, numberOfCards, incrementCards, decrementCards, refreshPokemons}: NavbarProps): JSX.Element => {
  
  return (
    <nav>
      <div className="timer">1:00</div>
      <div className="reset" onClick={()=>refreshPokemons(numberOfCards)}><span className="material-icons">restart_alt</span></div>
